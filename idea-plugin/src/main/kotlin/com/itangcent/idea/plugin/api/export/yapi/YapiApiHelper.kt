...
fun YapiApiHelper.findApiByPath(apiInfo: HashMap<String, Any?>): Int? {
    val path = apiInfo["path"] ?: return null
    val method = apiInfo["method"] ?: return null
    ...
    for (cart in carts) {
        ...
        val id = this.listApis(token, cart_id, null)?.firstOrNull { api ->
